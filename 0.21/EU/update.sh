...
wait
sudo wget https://piscesminer.oss-cn-hangzhou.aliyuncs.com/firmware/0.21/sys.config -O /home/pi/hnt/script/update/0.21/sys.config;
wait
...
quay.io/team-helium/miner:miner-amd64_2021.11.11.0_GA
